...
MUTATION_PROBABILITY = 0.05  # np. 5% szansy na mutację
MUTATION_TYPE = 'bit_flip'  # lub 'random_reset'
...
if __name__=="__main__":
    ...
    offspring1 = mutate(offspring1, demand_volume, mutation_type=MUTATION_TYPE, mutation_prob=MUTATION_PROBABILITY)
    ...
    offspring2 = mutate(offspring2, demand_volume, mutation_type=MUTATION_TYPE, mutation_prob=MUTATION_PROBABILITY)

    print(offspring2)
    print()
    print(f'Demand Volume(key is demand number (d), value is demand_volume (h_d)):\n{demand_volume}')
